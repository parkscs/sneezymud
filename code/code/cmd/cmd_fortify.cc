...
int TBeing::doFortify()
{
  ...
  if (!(obj = heldInSecHand()) || !(tbc = dynamic_cast<TBaseClothing *>(obj)) || !tbc->isShield()) {
  ...
  // Skill success
  act("You take up a defensive posture, sinking in behind your shield and preparing to defend against incoming attacks!", FALSE, this, NULL, NULL, TO_CHAR);
